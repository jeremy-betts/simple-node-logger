...
const SIGHUPFileAppender = require( './SIGHUPFileAppender' );
...
const SimpleLogger = function(opts) {
    ...
    /**
     * create a sighup file appender and add it to the appender list
     *
     * @param opts
     * @returns the appender
     */
    this.createSighupFileAppender = function( opts ) {
        return manager.addAppender( new SIGHUPFileAppender( opts ) );
    };
 ...
 * @returns logger
 */
SimpleLogger.createSighupFileLogger = function(options) {
    'use strict';
    ...
    manager.createSighupFileAppender( opts );
